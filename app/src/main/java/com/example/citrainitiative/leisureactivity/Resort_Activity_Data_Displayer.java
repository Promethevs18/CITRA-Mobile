...
public class Resort_Activity_Data_Displayer extends AppCompatActivity {

    ImageView back;
    KenBurnsView kbResort;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.leisure_resort_interface);
        AlertDialog.Builder build = new AlertDialog.Builder(Resort_Activity_Data_Displayer.this);

        //basic implementations of widgets
        book = (Button) findViewById(R.id.book);
        radioGroup = (RadioGroup) findViewById(R.id.classes);
        kbResort = (KenBurnsView) findViewById(R.id.imageMain);
        ...
        Picasso.get().load(imageUrl).into(kbResort);
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference().child("Leisure").child("Resort").child(place).child("phoneNums");
        Spinner phones = findViewById(R.id.phoneNum);
        ArrayAdapter<String> numberAdapter = new ArrayAdapter<String>(Resort_Activity_Data_Displayer.this, android.R.layout.simple_spinner_dropdown_item, phoneFirebase);
        ...
        phones.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                Toast.makeText(Resort_Activity_Data_Displayer.this, finalNum, Toast.LENGTH_SHORT).show();
            }
        });
                    ...
                    if (name.getText().toString().equals("") || deets.getText().toString().equals("")) {
                        ...
                        build.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(Resort_Activity_Data_Displayer.this, "The message has been sent to " + finalNum, Toast.LENGTH_LONG).show();
                            }
                        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Resort_Activity_Data_Displayer.this.finish();
            }
        });
    ...
    public void setImageGallery(){
        ...
        FirebaseRecyclerOptions galleryQueue = new FirebaseRecyclerOptions.Builder<gallery_display_data>()
                .setQuery(FirebaseDatabase.getInstance().getReference().child("Gallery").child("Leisure").child("Resort").child(place).orderByValue(), gallery_display_data.class)
                .build();
        galleryAdapter = new galleryAdapter(Resort_Activity_Data_Displayer.this,galleryQueue);
